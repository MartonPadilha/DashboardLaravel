...
<div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('client.update', ['client' => $client->id]) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' Nome Inválido!' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Nome') }}" value="{{ $client->name }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('phone') ? ' Telefone Inválido!' : '' }}" name="phone" id="phone" type="number" placeholder="{{ __('Telefone') }}" value="{{ $client->phone }}" required="true" aria-required="true"/>
                        @if ($errors->has('phone'))
                    ...
                    <div class="col-sm-4">
                      <div class="form-group{{ $errors->has('city') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('city') ? ' Cidade inválida!' : '' }}" name="city" id="city" type="text" placeholder="{{ __('Cidade') }}" value="{{ $client->city }}" required="true" aria-required="true"/>
                        @if ($errors->has('city'))
                    ...
                    <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('neighborhood') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('neighborhood') ? ' Bairro inválido!' : '' }}" name="neighborhood" id="neighborhood" type="text" placeholder="{{ __('Bairro') }}" value="{{ $client->neighborhood }}" required="true" aria-required="true"/>
                  ...
                  <div class="row">
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('address') ? ' Rua inválida!' : '' }}" name="address" id="address" type="text" placeholder="{{ __('Rua') }}" value="{{ $client->address }}" required="true" aria-required="true"/>
                    ...
                    <div class="col-sm-1">
                      <div class="form-group{{ $errors->has('number') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('number') ? ' Número inválido!' : '' }}" name="number" id="number" type="number" placeholder="{{ __('N') }}" value="{{ $client->number }}" required="true" aria-required="true"/>
