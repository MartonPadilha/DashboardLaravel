@extends('layouts.app', ['activePage' => 'user-management', 'titlePage' => __('Gerenciamento de Clientes')])
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 text-right">
                    <a href="{{ route('user.create') }}" class="btn btn-sm btn-primary">{{ __('Adicionar Cliente') }}</a>
                  </div>
                </div>
